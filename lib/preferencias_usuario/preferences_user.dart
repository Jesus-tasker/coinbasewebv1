...
//inicia la busqueda de preferncas
  ...
  double get fichas_1 {
    return _prefs?.getDouble('fichas1') ?? 0.0;
  }

  set fichas_1(double value) {
    _prefs?.setDouble('fichas1', value);
  }

  double get diamantes {
    return _prefs?.getDouble('diamantes') ?? 0.0;
  }

  set diamantes(double value) {
    _prefs?.setDouble('diamantes', value);
  }
}
